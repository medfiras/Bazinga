    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('draft_at', models.DateTimeField(null=True, verbose_name='Draft created at', blank=True)),
                ('attachment', models.FileField(upload_to=b'private_messages', null=True, verbose_name='Attachment', blank=True)),
