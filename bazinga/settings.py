...
DJANGO_SETTINGS_MODULE = 'bazinga.settings'
...
ADMINS = (
    ('MedFiras', 'hajjejfiras@gmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'bazinga_db',                      # Or path to database file if using sqlite3.
...
AUTHENTICATION_BACKENDS = (
    ...
    # 'MyProfile.auth_backends.CustomUserModelBackend',
)

# CUSTOM_USER_MODEL = 'profile.Profile'
